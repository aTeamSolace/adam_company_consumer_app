...
import 'package:adam_company_consumer_app/ui/page_data/rejected_tab_card.dart';
...
class RejectedJobs extends StatefulWidget {
  @override
...
class _selectionScreen extends State<RejectedJobs> {
...
//    print("user_id:${user_id}");
  ...
  Future getRequestedServices(var user_id) async {
    final response = await http.post(
        get_rejected_service + user_id.toString());
    if (response.statusCode == 200) {
      List<GetRequestedModelResult> requestedService;
      if (this.mounted) {
        setState(() {
          final responseJson = json.decode(response.body);
          // print("Rejected Service Data :${responseJson}");
                    ...
                    child: PlatformScrollbar(
                      child: ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            ...
                            return WidgetANimator(RejectedTabCard(
