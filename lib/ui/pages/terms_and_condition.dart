...
class _selectionScreen extends State<TermsAndCondition> {
  bool loading;
  ...
  Future getHelp() async {
    final response = await http.get(privacy_policy);
    if (this.mounted) {
      setState(() {
        // loading = true;
    ...
    return WillPopScope(
      ...
      child: Scaffold(
          ...
          appBar: AppBar(
            ...
            centerTitle: true,
            title: customText(
                termscond, 18, WidgetColors.blackColor, FontWeight.w400),
          ),
          body: Container(
              child: loading
